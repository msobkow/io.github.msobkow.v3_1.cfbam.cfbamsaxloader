...
/*
 *	CFBamSaxLoaderTableInfoParse XML SAX Element Handler implementation
 *	for TableInfo.
 */
public class CFBamSaxLoaderTableInfo
	extends CFLibXmlCoreElementHandler
{
	public CFBamSaxLoaderTableInfo( CFBamSaxLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		ICFBamTableInfoObj origBuff = null;
		ICFBamTableInfoEditObj editBuff = null;
		...
		try {
			...
			origBuff = (ICFBamTableInfoObj)schemaObj.getTableInfoTableObj().newInstance();
			editBuff = (ICFBamTableInfoEditObj)origBuff.beginEdit();
			...
			if( editTableInfo != null ) {
				if( origTableInfo != null ) {
					...
					origTableInfo = (ICFBamTableInfoObj)editTableInfo.create();
				}
				editTableInfo = null;
			}
